...
<body class="g-sidenav-show  bg-gray-100">
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                  <div class="d-flex flex-column">
                    ...
                    <span class="text-xs">DOB :<span class="text-dark ms-sm-2 font-weight-bold">{{$application->dob->format('d/m/Y')}}</span></span>
                  </div>
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Job Title</th>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Total Applications</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Edit / Delete</th>
                    </tr>
                  </thead>
                  <tbody>
                    @forelse ($jobs as $job)
                    <tr>
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="text-xs font-weight-bold">{{$job->location}}</span>
                      </td>
                      ...
                      <td class="align-middle text-center text-sm">
                        ...
                        <form action="{{ route('Job.destroy', $job->id) }}" method="POST" style="display: inline;">
                          @csrf
                          @method('DELETE')
                          <button type="submit" class="btn btn-link text-dark p-0" title="Delete" style="margin-bottom: 0px;" onclick="return confirm('Are you sure you want to delete this job?');">
                    ...
                    @empty
                    <tr>
                      <td colspan='6' class="text-center">No jobs listed</td>
                    </tr>
                    @endforelse
    ...
    <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Dashboard theme selector</h5>
      ...
      <div class="card-body pt-sm-3 pt-0">
       ...
       <div class="w-100 text-center">
        <h6 class="mt-3">Make it your way!</h6>
  ...
  <!--  
 Script for fading the pop up completion message -->
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      if (alert) {
        setTimeout(function() {
          alert.style.transition = "opacity 0.5 ease";
